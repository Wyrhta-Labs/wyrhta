...
Read and follow the canonical repo skill at:

`../../../.agents/skills/wyrhta-dev-env/SKILL.md`

This file exists only so OpenCode/Superpowers-style skill discovery can find the
skill without duplicating the operating instructions.
